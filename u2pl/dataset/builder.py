...
from .coco import build_coco_semi_loader, build_cocoloader
...
def get_loader(cfg, seed=0):  
    ...
    elif cfg_dataset["type"] == "pascal_semi":  # zou
    ...
    elif cfg_dataset["type"] == "coco_semi":
        train_loader_sup, train_loader_unsup = build_coco_semi_loader(
            "train", cfg, seed=seed
        )
        val_loader = build_cocoloader("val", cfg)
        logger.info("Get loader Done...")
        return train_loader_sup, train_loader_unsup, val_loader
    else:
