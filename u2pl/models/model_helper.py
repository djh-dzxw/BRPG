...
class ModelBuilder(nn.Module):
    def __init__(self, net_cfg):
        ...
        self._use_auxloss = True if net_cfg.get("aux_loss", False) else False  # True
        self.fpn = True if net_cfg["encoder"]["kwargs"].get("fpn", False) else False  # True
        if self._use_auxloss:  
            cfg_aux = net_cfg["aux_loss"]  # aux_plane: 1024，loss_weight: 0.4
            self.loss_weight = cfg_aux["loss_weight"]  # 0.4
    ...
    def _build_module(self, mtype, kwargs):
        ...
        #  u2pl.models.resnet， resnet101；u2pl.models.decoder，dec_deeplabv3_plus
